...
document.addEventListener("DOMContentLoaded", function (e) {
    LS.getItem("opt_obj").then((opt) => {
        ...
        var rng = document.querySelector('input[id="detectval"]');

        var durationListener = function () {
            window.requestAnimationFrame(function () {
                document.querySelector('label[id="detectvallbl"]').textContent = rng.value;
            });
        };

        rng.addEventListener("mousedown", function () {
            durationListener();
            rng.addEventListener("mousemove", durationListener);
        });
        rng.addEventListener("mouseup", function () {
            rng.removeEventListener("mousemove", durationListener);
        });
        ...
        rng.addEventListener("keydown", durationListener);
